...
public class Game {
    ...
    public ArrayList<Render> getRenders() {
        ...
        renders.add(new Render(0, 0, "C:\\Users\\admin\\Desktop\\FlappyBird-master\\FlappyBird-master\\lib\\background.png"));
        for (Pipe pipe : pipes)
            renders.add(pipe.getRender());
        renders.add(new Render(0, 0, "C:\\Users\\admin\\Desktop\\FlappyBird-master\\FlappyBird-master\\lib\\foreground.png"));
